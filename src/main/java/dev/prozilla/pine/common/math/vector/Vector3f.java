...
/**
 * Represents a (x,y,z)-Vector. GLSL equivalent to vec3.
 */
public class Vector3f {
     ...
     * @return Scalar product of this vector and the scalar
     */
     ...
     * @param scalar Scalar to multiply
     * @return Scalar quotient of this vector and the scalar
     */
    ...
    /**
     * Stores this vector in a given Buffer.
     * @param buffer The buffer to store this vector data in
     */
