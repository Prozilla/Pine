 ...
 */
public class SimpleMutableObjectProperty<T> implements MutableObjectProperty<T> {
	 ...
	 */
	public SimpleMutableObjectProperty() {
		this(null);
	}
	 ...
	 */
	public SimpleMutableObjectProperty(T initialValue) {
		value = initialValue;
	}
